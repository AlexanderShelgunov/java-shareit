...
public class UserControllerIntegrationTest {
    ...
    void testGetUserById() {
        UserDto createdUser = userService.createUser(userDto);
        UserDto userFromGet = userService.getUser(createdUser.getId());
    ...
    void testUpdateUser() {
        ...
        UserDto oldUserFromGet = userService.getUser(oldUser.getId());
        assertThat(oldUserFromGet, notNullValue());
        UserDto updatedUser = userService.updateUser(UserDto.builder().name("nameUpdate").build(), oldUser.getId());
        UserDto updateUserFromGet = userService.getUser(updatedUser.getId());
